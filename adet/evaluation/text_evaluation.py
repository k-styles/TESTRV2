...
class TextEvaluator(DatasetEvaluator):
    ...
    def sort_detection(self, temp_dir):
        #print("SORT DETECTION CALLED")
        #print(f"[evaluation/text_evaluation.py]: Name of the temp_dir: {temp_dir}")
        ...
        for i in files:
            ...
            for iline, line in enumerate(fin):
                ...
                #print(f"[evaluation/text_evaluation.py]: Points (pts): {pts} | {pgt.is_valid}")
                if not pgt.is_valid:
                    #print("[evaluation/text_evaluation.py]: Nope, pgt.is_valid is False")
                    print('An invalid detection in {} line {} is removed ... '.format(i, iline))
                    continue
                ...
                outstr = outstr+',####' + rec
                #print(f"[evaluation/text_evaluation.py]: Writing a line in {out}")
